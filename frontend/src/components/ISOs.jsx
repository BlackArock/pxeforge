    ...
    <>
      ...
      <div className="card">
        {isos.length === 0 ? (
          ...
          <table>
            <thead><tr><th>Filename</th><th>Size</th><th>Status</th><th>Added</th><th></th></tr></thead>
            <tbody>
              {isos.map(iso => (
                <tr key={iso.id}>
                  <td>
      ...
      {preloaded.length > 0 && isos.length > 0 && (
